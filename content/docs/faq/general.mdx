...
{vars.productName} includes custom theme components. The major customizations are in `DocItem/Content` (last-updated placement), `Tabs` (URL sync), and `Admonition/Icon` (custom SVGs).
