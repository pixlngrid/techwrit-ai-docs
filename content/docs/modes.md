...
- **Doc Type** — API reference, How-to guide, Quick start guide, Conceptual overview, Tutorial, Release notes, Troubleshooting guide, README, Runbook, Migration guide, Architecture decision record, or FAQ. The AI adapts structure and formatting. (Technical Writing only.)
