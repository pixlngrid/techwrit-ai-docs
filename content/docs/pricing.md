...
- Custom prompts (create your own beyond the 4 built-in)
...
Free tier request counts reset on the 1st of each month. The reset happens automatically on your next request after the new month begins.

## Upgrading

Select **Upgrade to Pro** in the user menu. Pro includes a 14-day free trial — you won't be charged until the trial ends. After checkout, your tier updates immediately and limits are lifted.

## Managing your subscription

Pro subscribers can select **Manage billing** in the user menu to open the Stripe billing portal. From there you can update payment methods, view invoices, or cancel.
